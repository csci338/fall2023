...
* All of your work will be done within the **class-exercises-fall2023** repo inside your directory.
...
* When it's time to issue the `git clone https://github.com/docker/getting-started-app.git` command, issue it inside of *your directory*. For instance:
    * `cd class-exercises-fall2023/vanwars`
    * `git clone https://github.com/docker/getting-started-app.git`
* After you've cloned, delete the **`class-exercises-fall2023/<your-username>/getting-started-app/.git`** folder (so that you don't have a repo inside a repo):
